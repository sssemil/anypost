...
- [ ] ts-mls v1.6.1 tested in browser — document what works and what doesn't
- [ ] ts-mls v2.0.0-rc.8 tested in browser — document what works and what doesn't
- [ ] MLS group lifecycle (create, add member, encrypt, decrypt, remove member) demonstrated
- [ ] Go/no-go recommendation with version choice and rationale documented
- [ ] Any browser-specific workarounds or polyfills identified
